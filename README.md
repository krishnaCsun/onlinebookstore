# <a href="https://theonlinebookstore.herokuapp.com" target="_blank"> CSUN Online Book Store </a> 
- A Java Web Developement Project integrated with tests
- Tests Implemented
    End to End Testing
    Unit Testing
...
### About
A 2 way user and admin-friendly Online Bookstore project in which users can log in or register, view the available books, select books along with their quantity, and buy them. Users can also get payment receipts after successful payment. Administrator can add new books, remove books, increase and decrease the quantity of books, change the price of the books as well as maintain the selling history of books.

![onlinebookstore](WebContent/Photo.jpg)
...
<bold>Thank you Prof. Harry - California State University, Northridge</bold><br/>
                                                                                                        Project Leader<br/>
                                                                                                         <b>Krishna Kanth</b>
